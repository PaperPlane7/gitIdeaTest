...
<div class="limiter">
    <div class="container-login100">
        <div class="wrap-login100">
            <form class="login100-form validate-form" action="${pageContext.request.contextPath}/user/commonuser" method="post">
                ...
                <div class="text-center p-t-115">
                    <a class="txt2" href="${pageContext.request.contextPath}/jsp/register.jsp">
                        注册
                    </a>
                </div>
            </form>
